...
/*
 ...
 For n2 however, T is always int, so sum always takes an int as the first parameter, and returns an int, even when we pass 0.5. What happens when we pass a double argument to an int parameter? 
