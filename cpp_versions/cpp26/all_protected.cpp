...
// Checks: "Can I compare P values with ==?"
// Answer: ✅ YES (pointers can always compare)
...
if(auto c = std::count(a, a + 10, nullptr); c != 10){ //how many values within a[] equal to nullptr
